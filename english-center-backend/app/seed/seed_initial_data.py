...
#             course.requirements = [
#                 {
#                     "id": f"{course.id}-req-1",
#                     "requirement_text": "Hoàn thành bài kiểm tra đầu vào",
#                     "order_index": 0,
#                 },
#                 {
#                     "id": f"{course.id}-req-2",
#                     "requirement_text": "Có thời gian học tối thiểu 3 buổi mỗi tuần",
#                     "order_index": 1,
#                 },
#             ]
...
#             course.outcomes = [
#                 {
#                     "id": f"{course.id}-out-1",
#                     "outcome_text": "Nắm vững nền tảng kỹ năng chính",
#                     "order_index": 0,
#                 },
#                 {
#                     "id": f"{course.id}-out-2",
#                     "outcome_text": "Sẵn sàng học lên cấp độ tiếp theo",
#                     "order_index": 1,
#                 },
#             ]
