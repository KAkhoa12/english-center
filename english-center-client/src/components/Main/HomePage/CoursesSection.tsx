...
export default function CoursesSection() {
  ...
  useEffect(() => {
    void listCourses({ page: 1, page_size: 6, status: "active" });
  }, [listCourses]);

  return (
    <section id="courses" className="relative overflow-hidden bg-gray-50 py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading
          ...
          highlight="phù hợp"
          suffix="mọi nhu cầu"
          description="Lộ trình cá nhân hóa từ người mới bắt đầu đến luyện thi chứng chỉ quốc tế."
        />

        <div className="fade-up grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {!isLoading && featuredCourses.length === 0 ? (
          <p className="mt-8 text-center text-sm text-gray-500">Chưa có khóa học nổi bật.</p>
        ) : null}
      </div>
    </section>
  );
